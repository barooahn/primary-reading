...
export default function Home() {
	...
	return (
		<>
			...
			<section className='relative hero-arc-layout bg-white overflow-hidden'>
				...
				<div className='absolute inset-0 flex items-center justify-center pt-16 z-10'>
					<div className='px-4 pb-20'>
						...
						>
							...
							<p className='text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto leading-relaxed mb-10 font-medium'>
