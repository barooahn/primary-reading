...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen min-h-[100dvh] bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 relative overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-4 lg:space-y-6 text-center lg:text-left">
              ...
              <div className="space-y-4">
                <h2 className="text-3xl lg:text-5xl font-black text-gray-900 font-heading leading-tight">
                  {role === 'student' ? (
              ...
              {/* Feature Preview - Hidden on mobile to save space */}
              <div className="hidden lg:block">
                {role === 'student' ? (
                  <div className="bg-white/60 backdrop-blur-sm border border-white/30 rounded-2xl p-6 shadow-sm">
