...
export default function TestAPIPage() {
  ...
  const [storyResult, setStoryResult] = useState<{ title?: string; content?: string; success?: boolean; error?: string } | null>(null);
  const [imageResult, setImageResult] = useState<{ imageUrl?: string; success?: boolean; error?: string } | null>(null);
