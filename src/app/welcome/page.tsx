				...
				{!selectedRole ? (
					...
					<div className="text-center space-y-8">
						...
						<div className="space-y-4 mb-12">
							<div className="flex items-center justify-center space-x-2 mb-4">
								...
								<h1 className="text-3xl md:text-4xl font-bold text-gray-900">PrimaryReading</h1>
							</div>
						...
						<div className="mt-16 max-w-4xl mx-auto">
							...
							<div className="grid md:grid-cols-3 gap-6 text-center">
								<div className="space-y-2">
									...
									<p className="text-sm text-gray-600">AI-generated illustrations that bring stories to life</p>
								</div>
								<div className="space-y-2">
									<div className="text-3xl">🎯</div>
									<h4 className="font-medium">Perfect Level</h4>
									<p className="text-sm text-gray-600">Content matched to your exact reading ability</p>
								</div>
								<div className="space-y-2">
									<div className="text-3xl">🏆</div>
									<h4 className="font-medium">Fun Learning</h4>
									<p className="text-sm text-gray-600">Comprehension questions that feel like games</p>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="max-w-2xl mx-auto text-center space-y-8">
						<div className="space-y-4">
							...
							<h2 className="text-3xl font-bold text-gray-900">Parent/Teacher Setup</h2>
									...
									<div className="space-y-3 text-sm">
										<div className="flex items-start space-x-3">
											...
											<div>
												...
												<p className="text-gray-600">Control what content is appropriate for each child&apos;s age and ability</p>
											</div>
										</div>
										<div className="flex items-start space-x-3">
											...
											<div>
												...
												<p className="text-gray-600">Monitor reading achievements and comprehension scores</p>
											</div>
										</div>
										<div className="flex items-start space-x-3">
											...
											<div>
												...
												<p className="text-gray-600">Create profiles for multiple students or children</p>
											</div>
										</div>
									</div>
								</div>
					...
					<div className="max-w-2xl mx-auto text-center space-y-8">
						<div className="space-y-4">
							...
							<h2 className="text-3xl font-bold text-gray-900">Ready to Read! 📚</h2>
							<p className="text-lg text-gray-600">
